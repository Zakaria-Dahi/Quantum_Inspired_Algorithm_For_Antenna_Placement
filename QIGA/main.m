...
%% Prameter  of the QGA search  algorithm  ----------------------
...
% ----------------------------------------------------------------------------------
%% --------------- Extract the Initial Best individual -----------------------------
...
population =  ((population * LR) + repmat(gbest,indiv,1))/(1 + LR);
%-----------------------------------------------------------------------------------
%% ---------------- Selection Process ----------------------------------------------
proba_vector = RW_selection(fit,indiv);
%-----------------------------------------------------------------------------------
%% ---------------- Creation of the Matting Pool -----------------------------------
Matting_population = Matting_pool(population,proba_vector,indiv,percentage);
%-----------------------------------------------------------------------------------

%% ---------------- Apply Crossover and Mutation ------------------------------------------------
population = cross_mut(Matting_population,percentage,indiv,Dimension,pcr,pm);
%-----------------------------------------------------------------------------------
...
%% ----- Update a new fitness ------------------------------------------------------
      fit(w) = result ;
%----------------------------------------------------------------------------------- 
end %-------------------------- End of the loop of all individuals -----------------
% ----------------------------------------------------------------------------------
...
save QGA.mat
end %------------------ End of the loop of Itteration ------------------------------
