function [final_area,transmitters,coverage,overcoverage,ratio,fitness] = VISUAL_three(population,Dimension,radius,GRID_SIZE_X,GRID_SIZE_Y,DIRECTIVE_XY,mask)
